...
train_data = np.load(
    "/home2/hky/github/Gamma_Energy/AllSky_withCR/Data/Crab_Dec_test_mulitysource.npz"
)
...
predictor = TabularPredictor(
    label=label,
    # sample_weight="weight",
    path="/home2/hky/github/Gamma_Energy/AllSky_withCR/agmodel/identitfy_gamma_CR_4par_mulitysource",
    eval_metric="roc_auc",
