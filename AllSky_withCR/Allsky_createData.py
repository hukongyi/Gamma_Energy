...
np.savez(
    f"/home2/hky/github/Gamma_Energy/AllSky_withCR/Data/Data_{sample_num},npz",
    **AllskyData,
)
AllskyData = np.load(
    f"/home2/hky/github/Gamma_Energy/AllSky_withCR/Data/Data_{sample_num}.npz"
...
if __name__ == "__main__":
    ...
    np.savez(
        f"/home2/hky/github/Gamma_Energy/AllSky_withCR/Data/Datawithe_Galactic_{sample_num}.npz",
        **AllskyData,
    )
